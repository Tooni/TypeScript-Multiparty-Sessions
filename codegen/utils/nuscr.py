...
def get_refinement_exprs(current_role: str, edges: typing.Dict) -> typing.Iterable[tuple[str, str]]:
...
def get_rec_exprs_updates(current_role: str, edges: typing.Dict) -> typing.Iterable[tuple[str, str, str]]:
